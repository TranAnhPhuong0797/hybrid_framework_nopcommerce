...
public class HomePageUI {
	...
	public static final String DROPDOWN_BY_COLUMN_INDEX_AND_ROW_INDEX = "xpath=//body//tr[%s]//td[%s]//select";
	...
	public static final String LOAD_DATA_BUTTON = "xpath=//button[contains(text(),'Load Data')]";
}
